...
namespace Server.Controllers
{
	...
	{
		private readonly IUserAccount _authservice;

		public AuthenticationController(IUserAccount authservice)
        {
		...
		public async Task<IActionResult> ResfreshTokenAsync(RefreshToken token)
		{
